 ...
 * 
 * UPDATED: Added "Shop" link to navigation pointing to shop.creativstudio.co
 */
...
const SITE = {
  ...
  shopUrl: 'https://shop.creativstudio.co',
    ...
    <header class="fixed top-0 left-0 right-0 z-50 bg-[#0D0D0D]/95 backdrop-blur-md border-b border-[#1f1f1f]">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav class="hidden lg:flex items-center gap-8">
            ...
            <a href="${SITE.shopUrl}" class="text-sm font-medium tracking-wide uppercase text-gray-300 hover:text-[#A3E635] transition-colors flex items-center gap-1.5" target="_blank" rel="noopener noreferrer">
              Shop
          ...
          <div class="hidden lg:block">
            <a href="${base}/contact.html" class="btn-accent inline-flex items-center px-6 py-2.5 rounded font-semibold text-sm tracking-wide uppercase">Get a Free Quote</a>
          </div>
      ...
      <div id="mobile-menu" class="mobile-menu lg:hidden bg-[#0D0D0D] border-t border-[#1f1f1f]">
        <div class="px-4 py-4 space-y-1">
          ...
          ${mobileServicesLinks}
          <a href="${SITE.shopUrl}" class="block py-3 text-sm font-medium uppercase tracking-wide text-[#A3E635] hover:text-[#BEF264]" target="_blank" rel="noopener noreferrer">
            Shop Online
            <svg class="w-3.5 h-3.5 inline ml-1 opacity-60" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
          </a>
          ...
          <a href="${base}/contact.html" class="btn-accent block text-center mt-4 px-6 py-3 rounded font-semibold text-sm tracking-wide uppercase">Get a Free Quote</a>
        </div>
      </div>
    </header>
  `;
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul class="space-y-2">
              ${serviceLinks}
              <li><a href="${SITE.shopUrl}" class="text-gray-400 hover:text-[#A3E635] transition-colors text-sm" target="_blank" rel="noopener noreferrer">Shop Online &rarr;</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><a href="${base}/contact.html" class="text-gray-400 hover:text-[#A3E635] transition-colors text-sm">Request a Quote</a></li>
            </ul>
          </div>
          <div>
